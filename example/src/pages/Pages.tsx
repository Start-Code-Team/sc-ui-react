    ...
    <div>
        <div className="w-60 h-full shadow-md bg-white absolute" id="sidenavSecExample">
            <div className="pt-4 pb-2 px-6">
                ...
                <div className="flex items-center">
                    <div className="grow m-3">
                        <h1 className="text-3xl font-semibold text-blue-600">Star Code Library</h1>
                    </div>
                </div>
                </a>
            </div>
            <ul className="relative px-1">
                ...
                <a className="flex items-center text-sm py-4 px-6 h-12 overflow-hidden text-gray-700 text-ellipsis whitespace-nowrap rounded hover:text-blue-600 hover:bg-blue-50 transition duration-300 ease-in-out active" href="#!" data-mdb-ripple="true" data-mdb-ripple-color="primary">
        ...
        <div className=" w-10/12 h-full absolute right-0">
          <main className=" mx-11 ">
            <SCButton onClick={() => {console.log('alert')}} className={'m-10'} primary={true}>Hello</SCButton>
            <SCButton secondary={true}>Hello</SCButton>
            <SCButton warn={true}>Hello</SCButton>
            <SCButton danger={true}>Hello</SCButton>
            <SCButton info={true}>Hello</SCButton>
            <SCButton success={true}>Hello</SCButton>
            <SCButton rounded={true}>Hello</SCButton>

            <SCButton ripple={true} href='#asd' rounded={true}>Hello</SCButton>
            ...
            <SCCard className="p-5 m-7" primary={true} onClick={() => {console.log('asd')}}>
                HOla
            </SCCard>
            <SCCard className="p-5 m-7" danger={true} href="asdasd">
                HOla
            </SCCard>
            <SCCard className="p-5 m-7">
                HOla
            </SCCard>
            <SCCard raised={true} className="p-5 m-7">
                HOla
            </SCCard>
            <SCCard raised={true} warn={true} className="p-5 m-7">
                HOla
            </SCCard>
            <SCCard bordered={true} primary={true} className="p-5 m-7">
                HOla
            </SCCard>
